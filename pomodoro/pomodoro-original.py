...
# from https://www.geeksforgeeks.org/create-a-pomodoro-using-python-tkinter/
# modified to use defines for intervals.
...
class Pomodoro:
    ...
    def main(self):
        ...
        tk.Label(self.root, text=":").pack(side=tk.LEFT)  # optional separator
